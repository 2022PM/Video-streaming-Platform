...
return() =>{
  ...
  return (
    <div className='grid grid-flow-col p-2 m-2 shadow-lg'>
      ...
      <img  onClick={()=>toggleMenuHandler()}  className='h-10 cursor-pointer' alt='Menu' src='https://paragondigital.com/wp-content/uploads/Menu-Icon2.jpg'/>
      <a href='/'><img className='h-10 mx-2-' alt="YoutubeLogo" src="https://logos-world.net/wp-content/uploads/2020/04/YouTube-Logo.png" /> </a>
      </div>
      ...
      {showSuggestion && (
      <div className='fixed bg-white py-5 px-2 w-[30rem] shadow-lg rounded-lg border bg-gray-100'>
      <ul>
        {suggestion.map(s=><li key={s} className='py-2 px-3 shadow-sm hover:bg-gray-200'>{s}</li>)}
